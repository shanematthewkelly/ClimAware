...
public class CampsDetailFragment3 extends Fragment  implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_camps3_detail, container, false);

        Animation SmallToBig = AnimationUtils.loadAnimation(getActivity(),R.anim.smalltobig);

        //init views
        rainforestImage = v.findViewById(R.id.circleview3);
